...
func (_m *MemClob) GetOrderbookUpdatesForOrderRemoval(ctx types.Context, orderId clobtypes.OrderId, reason indexersharedtypes.OrderRemovalReason) *clobtypes.OffchainUpdates {
	ret := _m.Called(ctx, orderId)
